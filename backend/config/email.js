...
const sendOTPEmail = async (email, otp) => {
  ...
  sendSmtpEmail.sender = {
    name: process.env.EMAIL_FROM_NAME || 'StayIndia',
...
// Send Booking Confirmation Email using Brevo
const sendBookingConfirmationEmail = async (userEmail, userName, bookingDetails) => {
  ...
  try {
    ...
    console.error('Brevo booking confirmation email error:', error);
    throw new Error('Failed to send booking confirmation email');
  }
};

// Send Check-in Reminder Email using Brevo
const sendCheckInReminderEmail = async (userEmail, userName, bookingDetails) => {
  const { listingTitle, checkIn, checkOut } = bookingDetails;
  ...
  try {
    ...
    console.error('Brevo check-in reminder email error:', error);
